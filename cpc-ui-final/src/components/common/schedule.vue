                    ...
                    <table>
                        <tbody @click="clickTbody">
                            <tr v-for="d in (type=='week'?weekOptions:dateList)">
                                ...
                                <td v-if="type=='week'" :class="{item: true, active: active(d.value, h)}" v-for="h in 24" :data="d.value.replace(/\//g,'') + ('0' + (h -1)).slice(-2)"></td>
                                <td v-else :class="{item: true, active: active(d, h)}" v-for="h in 24" :data="d.replace(/\//g,'') + ('0' + (h -1)).slice(-2)"></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
