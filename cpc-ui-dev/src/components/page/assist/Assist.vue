	...
	<div class="currentBody">
		<div class="source">
			<el-breadcrumb separator-class="el-icon-arrow-right">
				<el-breadcrumb-item :to="{ path: '/assist/assistLink'}">辅助工具</el-breadcrumb-item>
					...
					<div class="grid-content bg-purple">
						<el-menu :default-active="$route.path"  class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose" background-color="#545c64"  text-color="#fff" active-text-color="#ffd04b" unique-opened router>
							<el-submenu index="1">
								...
								<el-menu-item-group>
									<el-menu-item index="/assist/assistLink">监测链接</el-menu-item>
								</el-menu-item-group>
							</el-submenu>
							<el-submenu index="2">
								<template slot="title">
								...
								<el-menu-item-group>
									<el-menu-item index="/assist/assistRecord">日志查询</el-menu-item>
								</el-menu-item-group>
							</el-submenu>
						</el-menu>
					</div>
